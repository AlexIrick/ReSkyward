...
if __name__ == '__main__':
    ...
    assignments = [
        {
            ...
            'due': ['04/02/2023', '(5TH)'],
            'col': '5TH',
            'row': {'grade': '90', 'highlighted': True},
        },
        {
            'name': 'Chapter 6 Quiz',
            'due': ['03/29/2023', '(5TH)'],
            'col': '5TH',
            'row': {'grade': '98', 'highlighted': True},
        },
        {
            'name': 'Triangle Story',
            'due': ['03/29/2023', '(5TH)'],
            'col': '5TH',
            'row': {'grade': '99', 'highlighted': True},
        },
        {
            'name': 'Chapter 6 Progress',
            'due': ['03/27/2023', '(5TH)'],
            'col': '5TH',
            'row': {'grade': '100', 'highlighted': True},
        },
        {
            'name': 'Area HW',
            'due': ['03/26/2023', '(5TH)'],
        ...
        {
            'name': 'Trig Identity HW',
            'due': ['02/22/2023', '(5TH)'],
            'col': '5TH',
            'row': {'grade': '95', 'highlighted': True},
        },
        {
            'name': 'Ferris Wheel Presentations',
            'due': ['02/15/2023', '(4TH)'],
            'col': '4TH',
            'row': {'grade': '100'},
        },
        {
            'name': 'Obj. 1 Chapter 4',
            'due': ['02/13/2023', '(4TH)'],
            'col': '4TH',
            'row': {'grade': '94'},
        },
        {
            'name': 'Obj. 2 Chapter 4',
            'due': ['02/13/2023', '(4TH)'],
            'col': '4TH',
            'row': {'grade': '88'},
        },
        {
            'name': 'Obj. 3 Chapter 4',
            'due': ['02/13/2023', '(4TH)'],
            'col': '4TH',
            'row': {'grade': '100'},
        },
        {
            'name': 'Ferris Wheel Testing',
            'due': ['02/13/2023', '(4TH)'],
            'col': '4TH',
            'row': {'grade': '100'},
        },
        ...
        {
            'name': 'Critical Friends Presentations',
            'due': ['01/20/2023', '(4TH)'],
            'col': '4TH',
            'row': {'grade': '84'},
        },
    ...
    for row in grades_db.get_cursor().execute(
        "SELECT * FROM adv_pre_calculus_b ORDER BY due"
    ):  # WHERE col = '4TH'
        print(row)
